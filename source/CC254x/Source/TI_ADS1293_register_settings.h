...
* Channel 1 on set to Lead II ECG
* All other channels off
* DRDYB is controlled by Chnl 1
* Streaming mode only returns Chnl 1
* Decimation Rates set for 267Hz (R2=8, R3=12)
* Lead off detection is off

************************************************************/

#define TI_ADS1293_CONFIG_REG_VALUE                         (0x02)                  /* Main Configuration */

#define TI_ADS1293_FLEX_CH1_CN_REG_VALUE                    (0x19)                  /* Flex Routing Swich Control for Channel 1 */
#define TI_ADS1293_FLEX_CH2_CN_REG_VALUE                    (0x00)                  /* Flex Routing Swich Control for Channel 2 */
...
#define TI_ADS1293_CMDET_EN_REG_VALUE                       (0x05)                  /* Common Mode Detect Enable */
...
#define TI_ADS1293_AFE_SHDN_CN_REG_VALUE                    (0x36)                  /* Analog Front-End Shutdown Control */
#define TI_ADS1293_AFE_FAULT_CN_REG_VALUE                   (0x06)                  /* Analog Front-End Fault Detection Control */
...
#define TI_ADS1293_R2_RATE_REG_VALUE                        (0x08)                  /* R2 Decimation Rate */
#define TI_ADS1293_R3_RATE1_REG_VALUE                       (0x08)                  /* R3 Decimation Rate for Channel 1 */
#define TI_ADS1293_R3_RATE2_REG_VALUE                       (0x00)                  /* R3 Decimation Rate for Channel 2 */
...
#define TI_ADS1293_DIS_EFILTER_REG_VALUE                    (0x06)                  /* ECG Filters Disabled */
...
#define TI_ADS1293_ALARM_FILTER_REG_VALUE                   (0x13)                  /* Digital Filter for Analog Alarm Signals */
#define TI_ADS1293_CH_CNFG_REG_VALUE                        (0x10)                  /* Configure Channel for Loop Read Back Mode */
