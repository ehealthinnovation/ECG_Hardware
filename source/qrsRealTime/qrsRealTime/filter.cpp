...
{
	//high pass with fc =0.2
	static double a0 = -0.00379;
	static double a1 = 0.0991;
	static double a2 = -0.0953;
	static double b1 = 1.8649;
	static double b2 = -0.9084;

	static double xnt, xm1, xm2, ynt, ym1, ym2 = 0;
	xnt = data;

	ynt = a0*xnt + a1*xm1 + a2*xm2 + b1*ym1 + b2*ym2;
...
double testFilterHP(int data)
{
	...
	static double a1 = -2;
	static double a2 = 1;
	static double b1 = -1.9965194654496268;
	static double b2 =  0.99653049804511507;
...
{
	//low pass with fc =0.4
	static double a0 = 1;
	static double a1 = 2;
	static double a2 = 1;
	static double b1 = -1.1050043638955529;
	static double b2 = 0.48299247939587936;
